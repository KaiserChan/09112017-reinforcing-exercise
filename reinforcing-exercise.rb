...
# Explore the structure of the hash using the keys method.
puts hash.keys


# How many tracks are in this playlist? Save this value in a variable.
tracks = hash["tracks"].count
puts tracks


# What is the total duration of the playlist? Save this value in a variable.
# duration = hash["tracks"][4].sum

duration = Array.new

hash["tracks"].each do |entry|
  if entry.has_key?("duration_in_milliseconds")
    duration << entry["duration_in_milliseconds"]
  end
end
